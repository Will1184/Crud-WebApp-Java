...
<body onload="startTime()">
    ...
    <div id="clocks">
        ...
        <table class="table" id="table-inf">             
        <thead>
            <tr>
                <th>ID</th>
                <th>NOMBRES</th>                                
            ...
            <c:forEach var="persona" items="${lista}">
                <tr>
                    ...
                    <td>
                        ...
                        <button class="email"><a href="controller?accion=mostrarMail&id=<c:out value="${persona.id}" />"><span class="material-symbols-outlined mail">mail</span> SEND</a></button>
                    </td>                    
                </tr>                            
